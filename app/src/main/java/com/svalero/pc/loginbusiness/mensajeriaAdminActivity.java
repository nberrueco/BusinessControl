...
public class mensajeriaAdminActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.acivity_mensajes);
                            ...
                            public void onReceive(Context context, Intent intent) {
                                switch (getResultCode()){
                                    ...
                                    case SmsManager.RESULT_ERROR_RADIO_OFF:
                                        Toast.makeText(getApplicationContext(), "El envio ha fallado", Toast.LENGTH_SHORT).show();
                                        break;
                                }
                            }
